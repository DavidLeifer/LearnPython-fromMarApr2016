...
t.write("The highest420 city is: " + biggest_city[NAME])
...
# Question: Which city has the largest population?
# Write the result but make sure it's under the map
biggest_city = min(cities, key=lambda city: city[POP])
t.goto(0, -1*((map_height/2)+0))
t.write("The lowest city is: " + biggest_city[NAME])
